        ...
        <div class="container row center-block ">\
          <ul class="pull-left left-menu clearfix" id="nav-left-menu">\
            ...
            <li class="app-btn"><a href="https://www.csdn.net/app/" title="APP" target="_blank">APP</a>\
              ...
              <img src="https://www.csdn.net/app/img/wxfix.png" />\
              </div>\
            </li>\
              ...
              <li class="userLogin">\
                ...
                <div class="bord">\
                 <div><i class="pull_icon pull_icon3"></i><a class="xiaoxi" href="https://msg.csdn.net/" target="_blank">消息<span class="toolbar-newsL">(3)</span></a></div>\
                  ...
                  <div class="bord">\
                  <div><i class="pull_icon pull_icon5"></i><a href="//blog.csdn.net/'+currUser.userName +'" target="_blank">我的博客</a></div>\
...
$(function(){
  ...
  if (getCookie('tipShow')){
    console.log(getCookie('tipShow'),'走了隐藏逻辑hide')
...
$(function(){
  ...
  function goFn(obj,txt){
    ...
    function eduSearch(obj,txt){
      var searchTxt = encodeURIComponent(txt),
          url = "//edu.csdn.net/search?keywords="+searchTxt+"&type=0";
      if(searchTxt == ''){
          return false;
      }else{
        window.open(url)
    ...
    for(var i=0;i<myNav.length;i++){
        ...
        if(currenturl.indexOf(aurl)!=-1 && aurl != '//download.csdn.net'){
          myNav[i].className="active";
          myNav[0].className="";
        }
        if(currenturl.indexOf('//download.csdn.net/')!=-1 && currenturl.indexOf('vip_code') ==-1){
          myNav[3].className="active";
        }
    }
